    ...
    <div className="border rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
      {product.image ? (
        <Image
          ...
          onError={(e) => {
            // Hide the image and show the fallback div when image fails to load
      ...
      <div className="w-full h-48 bg-gray-200 flex items-center justify-center mb-4 hidden">
        <span className="text-gray-400">Image not available</span>
      </div>
      <h3 className="font-bold text-lg mb-2">{product.name}</h3>
      <p className="text-gray-600 mb-2">{product.price}/{product.quantityUnit}</p>
